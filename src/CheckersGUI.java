...
public class CheckersGUI {
    static int QUEEN_SIZE = 65;
    static int STONE_SIZE = 50;
    ...
    static ImageIcon black_piece = new ImageIcon("img/black_piece.png");
    static ImageIcon white_piece = new ImageIcon("img/white_piece.png");
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                ...
                if (x == 0) {
                    ...
                    if (pos[i][j] == 'B') {
                        buttons[i][j].setIcon(new ImageIcon(black_piece.getImage().getScaledInstance(STONE_SIZE, STONE_SIZE, Image.SCALE_SMOOTH)));
                    } else if (pos[i][j] == 'W') {
                        buttons[i][j].setIcon(new ImageIcon(white_piece.getImage().getScaledInstance(STONE_SIZE, STONE_SIZE, Image.SCALE_SMOOTH)));
                    }
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                if (pos[i][j] == 'B') {
                    ...
                    buttons[i][j].setIcon(new ImageIcon(black_piece.getImage().getScaledInstance(QUEEN_SIZE, QUEEN_SIZE, Image.SCALE_SMOOTH)));
                } else if (pos[i][j] == 'w') {
                    buttons[i][j].setIcon(new ImageIcon(white_piece.getImage().getScaledInstance(QUEEN_SIZE, QUEEN_SIZE, Image.SCALE_SMOOTH)));
                } else {
