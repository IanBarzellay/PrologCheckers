...
game(Board,Level):-
    ...
    (findWinner(TempBoard1,Winner, player),!,getBoard(TempBoard1),(Winner = "drew",!,write("Ok... we have a drew game this time...");write("The winner is "),write(Winner),write("!!!!!"));
    alpha_beta(computer,Level,TempBoard1,-200,200,Move,_),
    move(computer, TempBoard1, NewBoard, Move),
    getBoard(NewBoard),
    (findWinner(NewBoard,Winner, computer),!,(Winner = "drew",!,write("Ok... we have a drew game this time...");write("The winner is "),write(Winner),write("!!!!!"));game(NewBoard,Level))),!.
...
findWinner(Board,Winner, PlayerTurn):-
    ...
    queen_moves(15),!, %When the last 15 ture it was a queen's moves - drew
    Winner = "drew".
